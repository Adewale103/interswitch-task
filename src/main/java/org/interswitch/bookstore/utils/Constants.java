...
public class Constants {
    public final static String APPENDABLE_SEPARATOR = "_";
    public final static String ID = "id";
    public final static String REFERENCE = "reference";
    public static final String QUERY_PROP_SEPARATOR = ".";
    public static final String GREATER_THAN_INCLUSIVE = ":>";
    ...
    public static final String INVALID_TITLE = "Title must contain only numbers and letters";
